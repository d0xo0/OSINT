...
7 - BSSID
8 - Info Telegram
[{RED}*{CYAN}]{RED}{CYAN}Telegram: {RED}t.me/liber0net (Subscribe) {CYAN}
''')
...
{CYAN}[{RED}*{CYAN}] Possible names: {GREEN}{name}
	"""
			...
			print(f'{CYAN}[{RED}-{CYAN}] Error text!')
	elif shell == '3':
		...
		try:
			...
			print(f'{CYAN}[{RED}-{CYAN}] Subscribe to t.me/liber0net')
			if shell == '8':
		print('Telegram Channel : t.me/liber0net SUBSCRIBE, Please')
